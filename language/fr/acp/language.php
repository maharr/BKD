...
$lang = array_merge($lang, array(
	...
	'INVALID_LANGUAGE_PACK'		=> 'L’archive de langue que vous avez sélectionnée semble incorrecte. Veuillez la vérifier et la transférer de nouveau, si cela est nécessaire.',
	...
	'LANGUAGE_ENTRIES_EXPLAIN'			=> 'Vous pouvez modifier ici les clés de langue afin de les personnaliser ou de les traduire si elles ne le sont pas.<br /><strong>Note :</strong> une fois que vous avez modifié un fichier de langue, ce dernier sera stocké dans un répertoire séparé afin que vous puissiez le télécharger. Les modifications ne seront visibles aux utilisateurs qu’après avoir remplacé le fichier de langue original par le fichier de langue modifié en transférant celui-ci sur votre espace internet.',
	...
	'UPLOAD_FAILED'				=> 'Le transfert a échoué pour une raison inconnue. Vous devriez vérifier la structure du fichier que vous essayez de transférer et le remplacer si nécessaire.',
