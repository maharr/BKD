...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		<p>Les permissions sont multiples et regroupées en quatre grandes sections :</p>

		<h2>Permissions globales</h2>
		<p>Elles sont utilisées afin de contrôler l’accès de façon globale sur l’ensemble du forum. Elles sont divisées en permissions des utilisateurs, permissions des groupes, permissions des administrateurs et permissions des modérateurs globaux.</p>

		<h2>Permissions relatives aux forums</h2>
		<p>Elles sont utilisées afin de contrôler l’accès sur chaque forum individuel. Elles sont divisées en permissions des forums, permissions des forums aux modérateurs, permissions des forums aux utilisateurs et permissions des forums aux groupes.</p>

		<h2>Rôles de permissions</h2>
		<p>Elles sont utilisées afin de créer différents ensembles de permissions concernant les différents types de permissions qui peuvent être assignés ultérieurement aux rôles. Les rôles par défaut devraient couvrir l’administration des forums étant donné que dans chacune des quatre divisions, vous pouvez ajouter, éditer et supprimer des rôles selon vos besoins.</p>
	...
	'ACL_VIEW_EXPLAIN'		=> 'Vous pouvez consulter ici toutes les permissions effectives que détiennent l’utilisateur ou le groupe d’utilisateurs. Un rectangle rouge indique les permissions qu’il ne détient pas, un rectangle vert indique les permissions qu’il détient.',
	'ACL_YES'				=> 'Oui',
	...
	'ACP_FORUM_PERMISSIONS_EXPLAIN'				=> 'Vous pouvez modifier ici quels sont les utilisateurs et les groupes d’utilisateurs qui peuvent accéder à certains forums. Veuillez vous rendre sur la page appropriée afin d’attribuer des modérateurs ou définir des administrateurs.',
	...
	'ROLE_DESCRIPTION_ADMIN_USERGROUP'		=> 'Peut gérer les utilisateurs et les groupes d’utilisateurs (leurs permissions, leurs réglages, la gestion des bannissements et des rangs).',
	'ROLE_DESCRIPTION_FORUM_BOT'			=> 'Ce rôle est recommandé aux robots des moteurs de recherche.',
	'ROLE_DESCRIPTION_FORUM_FULL'			=> 'Peut utiliser toutes les fonctionnalités du forum, dont la publication d’annonces et de notes. Peut également ignorer la limitation de flood.<br />Ceci n’est pas recommandé auxutilisateurs normaux.',
	...
	'ROLE_DESCRIPTION_MOD_QUEUE'			=> 'Ne peut utiliser que la file d’attente de modération afin de valider ou éditer des messages.',
	'ROLE_DESCRIPTION_MOD_SIMPLE'			=> 'Ne peut utiliser que les actions de base liées aux sujets mais ne peut pas envoyer d’avertissements ou accéder à la file d’attente de modération.',
	'ROLE_DESCRIPTION_MOD_STANDARD'			=> 'Peut utiliser la plupart des outils liées à la modération mais ne peut pas bannir d’utilisateurs ou modifier l’auteur d’un message.',
	'ROLE_DESCRIPTION_USER_FULL'			=> 'Peut utiliser toutes les fonctionnalités du forum qui sont disponibles aux utilisateurs dont la possibilité de modifier son nom d’utilisateur ou d’ignorer la limitation de flood.<br />Ceci n’est pas recommandé.',
