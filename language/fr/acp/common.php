...
$lang = array_merge($lang, array(
	...
	'WRITABLE_CONFIG'		=> 'Votre fichier de configuration (config.php) est actuellement inscriptible par tout le monde. Nous vous encourageons fortement à modifier vos permissions en 640 (<a href="http://fr.wikipedia.org/wiki/Chmod" rel="external">chmod</a> 640 config.php) ou, si cela n’est pas possible, au moins en 644.',
));
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN'		=> 'Ceci est la liste des utilisateurs inscrits mais dont le compte est actuellement inactif. Si vous le souhaitez, vous pouvez activer, supprimer ou envoyer un rappel (par courriel) à ces utilisateurs.',
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'Ceci est la liste des dix derniers utilisateurs inscrits mais dont le compte est actuellement inactif. Si vous le souhaitez, vous pouvez consulter la liste complète de ces membres par l’intermédiaire du menu approprié ou en cliquant sur le lien ci-dessous d’où vous pourrez activer, supprimer ou envoyer un rappel (par courriel) à ces utilisateurs.',
