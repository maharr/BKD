...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'	=> 'Vous pouvez gérer ici l’ensemble des modules. Veuillez noter que le PCA est divisé en une structure à trois niveaux de menu (Catégorie -> Catégorie -> Module) où les autres sont divisés en une structure à deux niveaux de menu (Catégorie -> Module) qui doit être conservée. Veuillez également prendre en compte le fait que vous pouvez vous bloquer si vous désactivez ou supprimez les modules responsables de la gestion des modules.',
	...
	'CHOOSE_MODE_EXPLAIN'	=> 'Sélectionnez les modes du module qui seront utilisés.',
