...
در مراحل بعدی، به آسان ترین روش ممکن phpBB را نصب خواهید نمود.<br /><br />
		درگام نخست برای نصب phpBB نیاز به یک هاست مناسب و مطمئن دارید؛ برای اطلاعات بیشتر <b><a href="http://host.maghsad.com">اینجا</a></b>
یا
<b><a href="http://maghsad.net">اينجا كليك كنيد</a></b>.<br />
...
کلیک نمایید.</span></b><p>&nbsp;<p>',
	...
	'INSTALL_PANEL'				=> 'مرکز نصب گام به گام phpBB آسان نصب مقصد',
...
پشتيبانان يا ساير اعضا بهره مند شويد.</span><br /><br />

	<strong>راهنمای نصب ،مدیریت و نصب مود </strong> <span lang="en-us"><strong>phpBB</strong></span><strong> به زبان فارسی :</strong>
<br /><br />
سایت مقصد به عنوان مجری و پشتیبان بین المللی و انحصاری phpBB فارسی، به منظور رفاه حال کاربران، اقدام به انتشار کتاب راهنمای جامع phpBB 
به صورت کاملا تصویری و کاملا فارسی و گام به گام نموده است.
<a href="http://index.maghsad.com/phpbb-learning/phpbb-3-persian-farsi-manual-book-t3686.html">
برای اطلاعات بیشتر <span lang="fa">اینجا کلیک کنید</span></a><span lang="fa">.</span><br />

<center>
	<span class="style2">
	<a href="http://index.maghsad.com/phpbb-learning/phpbb-3-persian-farsi-manual-book-t3686.html" class="style12" style="text-underline: single;">
	<img alt="کتاب راهنما&#1740; جامع phpBB" longdesc="file:///C:/Users/Asef/Desktop/آموزش ساخت، مدیریت و راه اندازی فوروم توسط phpBB 3" src="http://phpbb.maghsad.com/index_files/phpbb_3_book.jpg" class="style7"></a></span><br />
</center>
...
<br />
با نصب phpBB متعهد می شوید از این سیستم برای بهره وری خلاف قوانین بین المللی، قوانین ایران و خلاف شرع استفاده نکنید.
<br />
...
<a href="http://index.maghsad.com/phpbb-news/topic-t6265.html">تاپیک رسمی سارقان و کلاه برداران اینترنتی</a> ثبت می گردد تا به صورت جهانی قابل پیگیری و دستیابی باشد.
...
. phpBB <span lang="fa">به </span>راحتي قابل ارتقاع به آخرين نسخه موجود و همچنين به  phpBB2 مي باشد. براي کسب اطلاعات بيشتر ، پيشنهاد مي کنيم <a href="../docs/INSTALL.html">راهنماي نصب</a> را مطالعه نماييد.<br /><br /><br /><br /> <br /><br />
<span class="style14">براي ادامه نصب ،به سربرگ نصب مراجعه نماييد</span>.<br />&nbsp;</p>
...
<b><a href="http://host.maghsad.com">اینجا</a></b>
یا
...
$lang = array_merge($lang, array(
 ...
 برای اطلاعات بیشتر در باره نحوه کار با phpBB به <a href="http://phpBB.Maghsad.com">پشتیبانی phpBB فارسی</a> مراجعه فرمایید.
همچنین می توانید برای استفاده از سایر خدمات مقصد به <a href="http://www.Maghsad.com">www.Maghsad.com</a> مراجعه فرمایید.
درصورت نیاز به <a href="http://Maghsad.com/host">هاست ارزان و امن</a> <a href="http:// Maghsad.net">اینجا کلیک کنید</a>.
